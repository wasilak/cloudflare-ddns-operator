...
import (
	...
	"github.com/wasilak/cloudflare-ddns-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(dnsentryv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0e59a257.mindthebig.rocks",
