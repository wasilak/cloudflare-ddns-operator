...
// +kubebuilder:rbac:groups=dnsentry.mindthebig.rocks,resources=dnsentries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dnsentry.mindthebig.rocks,resources=dnsentries/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=dnsentry.mindthebig.rocks,resources=dnsentries/finalizers,verbs=update
